"""Deterministic rule-based judge (Tier 1 of the multi-tier evaluation).
...
Runs a fixed battery of objective checks against a TraceRecord:
  ...
  * must_contain / must_not_contain keyword checks (used heavily by the
    injection test cases to catch prompt-injection compliance, and by
    failure-recovery cases to catch fabricated success claims)
  * latency budget
