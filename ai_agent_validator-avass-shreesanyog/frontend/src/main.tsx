...
import { Bot, Globe2, Play, ShieldCheck, Plus, Search, Activity, ChevronDown, ChevronUp, TerminalSquare, Gauge, ShieldAlert, GitBranch, Layers, Trash2, Brain, Award, RadioTower, FileCheck2, ClipboardList, Link2, GitCompare, Network } from 'lucide-react';
    ...
    <div className="min-h-screen pb-20">
      ...
      <main className="mx-auto max-w-7xl p-8">
        ...
        <section className="mt-6 card">
          <h2 className="text-lg font-semibold mb-4 flex items-center gap-2"><Gauge className="text-violet-400" size={20} /> AgentOps Portfolio KPIs</h2>
                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="text-xs text-slate-300 font-mono mt-1 space-y-1">
                      ...
                      <p>Est. Cost: <span className="text-emerald-400">${r.summary?.estimated_cost ? r.summary.estimated_cost.toFixed(5) : '0.00000'}</span> · Release Confidence: <span className="text-cyan-300">{r.release_confidence ?? '—'}%</span></p>
                    </div>
                  </div>
                </div>
