...
Computed from persisted Run/Result rows rather than a separate metrics
store, so every number is always reproducible from the evidence AVaaS
already keeps. Used both for the single-run summary and the tenant-wide
